...
# JavaScript to Fetch GPS Coordinates
gps_script = """
<script>
...
"""
st.components.v1.html(gps_script, height=50)

# Text input with auto-filled location
def get_location():
    return st.text_input("📍 Live Location (Latitude,Longitude):", "0,0")
